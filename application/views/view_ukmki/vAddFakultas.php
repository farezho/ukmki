  ...
  <body class="bg-dark">
    ...
    <div class="container">
      <div class="card card-register mx-auto mt-5">
        ...
        <div class="card-body">
          <form method="post" action="<?php echo base_url('superuser/aksi_addFakultas')?>">
            <div class="form-group">
              <div class="form-label-group">
                <input type="text" name="kode_fakultas" id="inputUsername" class="form-control" placeholder="Username" required="required">
                <label for="inputUsername">Faculty Code</label>
              </div>
            </div>
            <div class="form-group">
              <div class="form-label-group">
                <input type="text" name="deskripsi" id="inputName" class="form-control" placeholder="Full Name" required="required">
