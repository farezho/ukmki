    ...
    <div class="container">
      <div class="card card-register mx-auto mt-5">
        ...
        <div class="card-body">
          ...
          <form method="post" action="<?php echo base_url('crudAnggota/aksi_editAnggota/').$level?>">
            <div class="form-group">
              <div class="form-label-group">
                <input type="text" name="nama_lengkap" id="inputFName" class="form-control" value="<?php echo $u->nama_lengkap ?>" required="required">
            ...
            <div class="form-group">
              <div class="form-row">
                <div class="col-md-6">
                  <div class="form-label-group">
                    <input type="number" name="nim" id="inputNim" class="form-control" value="<?php echo $u->nim ?>" readonly>
                ...
                <div class="col-md-6">
                  <div class="form-label-group">
                    <select name="fakultas" id="fakultas" class="form-control" required="required">
                      <option selected="true" value="<?php echo $u->kode_fakultas ?>"><?php echo $u->deskripsi ?></option>
                ...
                <div class="col-md-6">
                  <div class="form-label-group">
                    <select name="amanah" id="amanah" class="form-control" required="required">
                      <option selected="true" value="<?php echo $u->kode_amanah ?>"><?php echo $u->deskripsi_amanah ?></option>
                ...
                <div class="col-md-6">
                  <div class="form-label-group">
                    <select name="status_kdr" id="status_kdr" class="form-control" required="required">
                      <option selected="true" value="<?php echo $u->kode_kdr ?>"><?php echo $u->deskripsi_kdr ?></option>
            ...
            <div class="form-group">
              <div class="form-row">
                <div class="col-md-6">
                  <div class="form-label-group">
                    <select name="status_mentoring" id="status_mentoring" class="form-control" onchange="munculTxtbox()" required="required">
                      <option selected="true" value="<?php echo $u->kode_exc ?>"><?php echo $u->deskripsi_exc ?></option>
                ...
                <div class="col-md-6" id="nama_mentor">
                  <div class="form-label-group">
                    <input type="text" name="nama_mentor" id="nama_mentor" class="form-control" value="<?php echo $u->nama_mentor ?>">
          ...
          <?php 
            if($level == "SU"){ ?>
              <div class="text-center">
                <a class="d-block small mt-3" href="<?php echo base_url('crudAnggota/lihatAnggota/').$level?>">Back</a>
              </div>
           <?php }else{ ?>
              <div class="text-center">
                <a class="d-block small mt-3" href="<?php echo base_url('crudAnggota/lihatAnggota/').$level?>">Back</a>
